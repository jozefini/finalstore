    ...
    <div className="relative mx-auto mt-32 w-full max-w-6xl px-4">
      ...
      <div className="relative">
        <div className="mb-10 text-center">
          {/* <div className="text-fd-muted-foreground mb-3 inline-flex items-center rounded-full border border-black px-4 py-1.5 text-xs font-bold uppercase tracking-wider">
            ARCHITECTURE
          </div> */}
