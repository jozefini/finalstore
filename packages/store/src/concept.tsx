...
import { createMap, createScopedStore, createStore } from './index';

export const concept = createScopedStore({
  states: {
    taskId: 1,
    theme: 'light',
    count: 0,
...
export function Concept() {
  const store = concept.useStore();
  const isDarkTheme = store.useSelector.isTheme('light');
